...
private:
    ...
    [[nodiscard]] VkFormat selectSupportedFormat(const std::vector<VkFormat>& candidates,
                                                 VkImageTiling tiling,
                                                 VkFormatFeatureFlags features) const;

    // API functions
    void configureDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) const;
    void configureInstanceCreateInfo(VkInstanceCreateInfo& createInfo,
    ...
    void drawCommand(VkCommandBuffer commandBuffer,
    ...
    void singleTimeCommands(TCallable&& callable)
    {
        static_assert(std::is_invocable_v<TCallable, VkCommandBuffer>,
                      "Function needs to take VkCommandBuffer as argument!");
